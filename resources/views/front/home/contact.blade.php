                ...
                <div class="row pb-5">
                    <div class="col-md-4">
                        <div class="contact-p">
                            ...
                            <p class="f-s-17">Phone : <a href="tel:+8801646688970" class="f-s-27 text-light dancing-script">+8801646688970</a></p>
                            <p class="f-s-17">Email : <a href="mailto:mainul125011@gmail.com" class="f-s-27 text-light dancing-script">mainul125011@gmail.com</a></p>
                            <p class="f-s-17">github: <a href="https://github.com/Mainul12501" class="f-s-27 text-light dancing-script">mainul12501</a></p>
                            <ul class="nav" style="margin-left: auto">
                                <li><a href="https://www.facebook.com/mainul.islam3320/" title="Facebook" class="nav-link text-light"><i class="fab fa-facebook fa-2x"></i></a></li>
                                <li><a href="https://www.linkedin.com/in/muhammad-ali-400506148" class="nav-link text-light"><i title="Linkedin" class="fab fa-linkedin fa-2x"></i></a></li>
                                <li><a href="https://github.com/Mainul12501" class="nav-link text-light"><i title="Github" class="fab fa-github fa-2x"></i></a></li>
                                <li><a href="https://twitter.com/Mainul125011" class="nav-link text-light"><i title="Twitter" class="fab fa-twitter fa-2x"></i></a></li>
                                <li><a href="javascript:void(0)" class="nav-link text-light"><i title="Skype" class="fab fa-skype fa-2x"></i></a></li>
